<section id="studiezaal" class="page visible nofooter">
    ...
    <div class="content">
            <flex-slider slide="page in passen.pages" animation="slide" progress-nav="true" animation-speed="1000" slideshow-speed="10000" direction-nav="false" keyboard="false" slideshow="true" class="slides" start-at="0">
