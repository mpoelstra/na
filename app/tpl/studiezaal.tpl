<section id="studiezaal" class="page visible nofooter">
    ...
    <div class="content">
            <flex-slider slide="page in passen.pages" animation="slide" animation-speed="1000" slideshow-speed="10000" direction-nav="false" keyboard="false" slideshow="true" class="slides" start="flexsliderStart" before="flexsliderBefore" after="flexsliderAfter" start-at="0">
